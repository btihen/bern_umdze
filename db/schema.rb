...
ActiveRecord::Schema.define(version: 20_210_911_181_216) do
  ...
  create_table 'attendances', force: :cascade do |t|
    ...
    t.index %w[user_id participant_id reservation_id], name: 'index_unique_attendance_per_reservation',
                                                       unique: true
  ...
  create_table 'reservations', force: :cascade do |t|
    ...
    t.index %w[event_id space_id start_date_time end_date_time], name: 'index_reservation_unique', unique: true

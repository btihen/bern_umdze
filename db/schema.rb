...
ActiveRecord::Schema.define(version: 2020_10_02_183702) do
  ...
  create_table "admins", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "admins_name", null: false
  ...
  create_table "umdzes", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "umdzes_name", null: false
    t.index ["confirmation_token"], name: "index_umdzes_on_confirmation_token", unique: true
    t.index ["email"], name: "index_umdzes_on_email", unique: true
    t.index ["reset_password_token"], name: "index_umdzes_on_reset_password_token", unique: true
    t.index ["unlock_token"], name: "index_umdzes_on_unlock_token", unique: true
  end

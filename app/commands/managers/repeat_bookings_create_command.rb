...
module Managers
  class RepeatBookingsCreateError < StandardError; end
end

module Managers
  class RepeatBookingsCreateCommand
    ...
    def create_repeat_reservations
      ...
      while next_start_date < repeat_until_max_date
    ...
    def next_end_date(next_start_date)
      ...
      next_start_date_time = DateTime.new(next_start_date.year, next_start_date.month, next_start_date.day,
    ...
    def calculate_next_start_date_day(increment_date)
      ...
      # when "last"
        ...
        raise Managers::RepeatBookingsCreateError, "#{repeat_ordinal} is an unsupported reapeat_ordinal"
    ...
    def days_offset(reference_date)
      ...
      when 'sun'
        ...
        raise Managers::RepeatBookingsCreateError, "#{repeat_choice} is an unsupported repeat_choise was enteren"
      end
    end
  end
end

...
module Managers
  class ReservationForm < FormBase
    ...
    def assign_reservation_attribs
      new_reservation = Reservation.find_by(id:) || Reservation.new
    ...
    def assign_repeat_attribs
      return nil   if repeat_every.zero? # && repeat_booking_id.blank?
